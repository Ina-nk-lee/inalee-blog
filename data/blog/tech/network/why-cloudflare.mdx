...
Cloudflare protects websites from distributed denial-of-service (DDoS) attacks—attacks designed to overwhelm your server with excessive traffic. It detects and handles suspiciously high volumes of traffic automatically.
